...
vim.keymap.set({'i', 'x', 'o'}, '<M-f>', 'w')
vim.keymap.set({'i', 'x', 'o'}, '<M-b>', 'b')
vim.keymap.set({'i', 'x', 'o'}, '', '')
vim.keymap.set({'i', 'x', 'o'}, '', 'I')
vim.keymap.set({'i', 'x', 'o'}, '', 'A')
vim.keymap.set({'i', 'x', 'o'}, '', 'I')
vim.keymap.set({'i', 'x', 'o'}, '', 'u')
vim.keymap.set({'i', 'x', 'o'}, '<C-S-W>', '"_dB')
vim.keymap.set({'i', 'x', 'o'}, '<C-Right>', 'W')
vim.keymap.set({'i', 'x', 'o'}, '<C-Left>', 'B')
